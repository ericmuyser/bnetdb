...
YShout.prototype = {
	...
	initForm: function() {
		...
		var postForm = 
			'<form id="ys-post-form" style="zoom:1;_height:30px;" ' + (this.prefs.inverse ? 'class="ys-inverse"' : '' ) + '><fieldset style="clear:none;zoom:1;">' +
				'<input id="ys-input-nickname" style="zoom:1" value="' + this.prefs.defaultNickname + '" type="text" accesskey="N" maxlength="' + this.prefs.nicknameLength + '" class="ys-before-focus" />' +
				'<input id="ys-input-message" style="zoom:1" value="' + this.prefs.defaultMessage + '" type="text" accesskey="M" maxlength="' + this.prefs.messageLength + '" class="ys-before-focus" />' +
			...
			'<div style="clear:both"></div></fieldset></form>';
